"""
Django settings for ComunidadConectada project.
...
SECRET_KEY = 'django-insecure-07aa32wxbmj6()ye2ipx_tzs64zs&c=pii7***p00w(+sp-!)o'
...
ROOT_URLCONF = 'comunidad_conectada.urls'
...
WSGI_APPLICATION = 'comunidad_conectada.wsgi.application'
